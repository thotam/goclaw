...
docker compose -f docker-compose.all.yml logs -f goclaw
```
...
```bash
docker compose -f docker-compose.all.yml restart goclaw
```
...
docker compose -f docker-compose.all.yml ps chrome

# Xem log chrome-proxy
docker compose -f docker-compose.all.yml logs chrome-proxy
```
...
```bash
docker exec -it $(docker compose -f docker-compose.all.yml ps -q goclaw) goclaw version
```
